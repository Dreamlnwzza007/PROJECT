...
# เลเยอร์ input layer
model.add(Dense(128, input_dim=X_train.shape[1], activation='relu'))  # เพิ่มจำนวน units เป็น 128

# เลเยอร์ hidden layer
model.add(Dense(128, activation='relu'))  # เลเยอร์ hidden ขนาด 128 units
model.add(Dropout(0.5))  # เพิ่ม Dropout layer เพื่อลด overfitting
